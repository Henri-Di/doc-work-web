<!DOCTYPE html>
<?php include'./pages/shortener/doc-work-web-create-short-url.php'; ?>
<html lang="pt-BR">
<head>
    <link rel="icon" href="./assets/images/icon.png" type="image/png">
    <title>Portifólio | Matheus Diamantino - Desenvolvedor Web</title>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col" id="box-info-page">
                ...
                <div>
                    <button onclick="window.location.href='./pages/novidades/novidades-doc-work-web.php';" id="btn-box-page">Sobre Novidades <i class="fa fa-star"></i></button>
                </div>
            </div>
