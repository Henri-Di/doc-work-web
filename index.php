...
<header>
	...
	<!-- CSS document page -->
    <link rel="stylesheet" href="./assets/scss/style-colors-index-page.scss">
...
<body>
	<div class="container">
		...
		<div class="row">
			...
			<div class="col" id="box-info-page">
			<h4 id="title-box-page">Portifólio <i class="fa fa-folder-open"></i></h4>
				<p id="text-box-page">
				...
				<button id="btn-box-page" onclick="window.location.href='./pages/portifolio/portifolio-doc-work-web.php';">
    				Sobre Portifólio <i class="fa fa-folder-open"></i>
				</button>
			...
			<h4 id="title-box-page">Contatos <i class="fa fa-bullhorn"></i></h4>
				...
				<div>
					<button id="btn-box-page">Sobre Contatos <i class="fa fa-bullhorn"></i></button>
				</div>
			</div>
		</div>
</div>
